...
class employeeClass:
    def __init__(self,root):
        ...
        #    title
        title=Label(self.root,text="Employee Details",font=("goudy old style",15),bg="blueviolet",fg="white").place(x=50,y=100,width=1000)
        ...
        lbl_saalry=Label(self.root,text="Salary",font=("goudy old style",15),bg="white").place(x=500,y=270)
        ...
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="red",fg="white").place(x=500,y=305,width=110,height=28)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),bg="blue",fg="white").place(x=620,y=305,width=110,height=28)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="black",fg="white").place(x=740,y=305,width=110,height=28)
        btn_clear=Button(self.root,text="clear",command=self.clear,font=("goudy old style",15),bg="grey",fg="white").place(x=860,y=305,width=110,height=28)

        emp_frame=Frame(self.root,bd=3,relief=RIDGE)
        emp_frame.place(x=0,y=350,relwidth=1,relheight=150)
