...
class IMS:
    def __init__(self,root):
        ...
        self.icon_side=PhotoImage(file="G:\IMS\images\side.png")
        ...
        self.lbl_employee=Label(self.root,text="Total Employee\n[ 0 ]",bd=5,relief=RIDGE,bg="antiquewhite1",fg="black",font=("goudy old style",20,"bold"))
        ...
        lbl_footer=Label(self.root,text="IMS-Inventory Management System    |   Developed Shivani\n",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
        self.update_content()
